...
public class Main {
    ...
    static private final  String HCP_NAMESPACE_URL = "http://bagas.training.hcp.lab.lo";
    static private final  String FILE_UPLOAD_PATH = "/opt/words.txt";
    static private final  String FILE_DOWNLOAD_PATH =  "/tmp/words.txt";

    public static void main(String[] args) {
        try {
            String auth = "HCP " + Utils.getBase64Value("teacher") + ":" + Utils.getMD5Value("bagas123");
...
//                + response.getStatusLine().getStatusCode() + " " + response.getStatusLine().getReasonPhrase());
    ...
    public static void getDirList(HttpClient client, String auth) throws IOException {
        //specify namespace URL - eg. namespace.tenant.HCP.DOMAIN.com/rest/path
        String url =   HCP_NAMESPACE_URL+"/rest/examples/";// +"deleted=true";
...
//                + response.getStatusLine().getStatusCode() + " " + response.getStatusLine().getReasonPhrase());
    ...
    public static void head(HttpClient client, String auth) throws IOException{
        //specify namespace URL - eg. namespace.tenant.HCP.DOMAIN.com/rest/path
        String url =   HCP_NAMESPACE_URL+"/rest/examples/world.txt";
...
//
//        String filePath = FILE_DOWNLOAD_PATH; ///tmp/outfile.txt""
...
//    }
    ...
    public static void putUsingChunks(HttpClient client, String auth) throws IOException{
        ...
        String localFilePath = FILE_UPLOAD_PATH; // "C:/Users/Administrator/git/HCPJavaRestExamples/world.txt";
...
//                + response.getStatusLine().getStatusCode() + " " + response.getStatusLine().getReasonPhrase());
    ...
    public static void delete(HttpClient client, String auth) throws IOException{
        //specify namespace URL - eg. namespace.tenant.HCP.DOMAIN.com/rest/path
        String url =   HCP_NAMESPACE_URL+"/examples/world.txt?";// +
...
//                + response.getStatusLine().getStatusCode() + " " + response.getStatusLine().getReasonPhrase());
    ...
    public static void addMetaData(HttpClient client, String auth) throws IOException{
        ...
        //specify path to file you want to upload(PUT)
        String localFilePath = FILE_UPLOAD_PATH ;
